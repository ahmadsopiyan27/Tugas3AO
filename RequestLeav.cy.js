describe('OrangeHRM Basic Tests', () => {
  ...
  const employeeUser = 'fathi1234';
  const employeePass = 'fathi123';
  ...
  it('Admin Login & Approve Leave', () => {
    ...
    cy.get('.oxd-autocomplete-text-input input').type('Fathi');
    cy.wait(1000);
    cy.contains('.oxd-autocomplete-option', 'Fathi').click();
